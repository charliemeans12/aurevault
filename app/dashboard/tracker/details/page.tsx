...
const TimelineItem = ({
  ...
  <div className="relative mb-[120px] flex items-center group">
    ...
    >
      <Icon className={`h-10 w-10 ${isActive ? "text-primary-foreground animate-pulse" : "text-primary"}`} />
    </div>
    <div className="ml-32 space-y-2">
      <div className="flex items-center gap-3">
        <span className={`h-3 w-3 rounded-full ${isActive ? "bg-primary animate-pulse" : "bg-accent"}`} />
